...
def write_headers(worksheet, clone, bold):
    field_names = ['seq_id','productive','in-frame','stop-codon','V','D','J','full_input','full_input_fromstart',
    ...
    for clone in clones:
        ...
        for s in seq_objs:
            seq_entry = [ s.entry_id, s.prod, s.inframe, s.stop_codon, s.top_v, s.top_d, s.top_j,
                         s.seq, s.full_fwr1_input, s.vdj_start, s.fwr1_beginning_nt, s.fwr1_beginning_aa,
...
def output_all(workbook, worksheet, library, library_name, filter_prod):
    ...
    for s in library.entries:
        ...
        seq_entry = [ s.entry_id, s.prod, s.inframe, s.stop_codon, s.top_v, s.top_d, s.top_j,
                        s.seq, s.full_fwr1_input, s.fwr1_beginning_nt, s.fwr1_beginning_aa,
